...
/*** IR3CH ***/
  class IR3CH{
    ...
    public:
      ...
      byte ReadTCRT(uint16_t TH, bool DEBUG);
...
/*** GoSUMO ***/
  class GoSUMO{
    ...
    public:
	  ...
	  void linetracking(uint8_t motion, uint16_t speed, uint16_t wheel_difference);
      void stop();
...
/*** MOTOR ***/
  class UAV{
    ...
    public:
      UAV(uint8_t pin, uint8_t channel);
      void act(uint16_t speed);
      void stop();
  };
